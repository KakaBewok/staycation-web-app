...
describe("API ENDPOINT TESTING", () => {
  ...
  it("GET Detail Page", (done) => {
    chai
      .request(app)
      .get("/api/v1/member/detail-page/64e9c0183ac87278af5e931f")
      .end((err, res) => {
        expect(err).to.be.null;
        expect(res).to.have.status(200);
        expect(res.body).to.be.an("object");
  ...
  it("POST Booking Page", (done) => {
    ...
    const dataSample = {
      image,
      idItem: "64e9c0183ac87278af5e931f",
      duration: 2,
    ...
    chai
      ...
      .field("accountHolders", dataSample.accountHolders)
      ...
      .end((err, res) => {
        ...
        expect(res.body.booking.idItem).to.have.all.keys(
          "_id",
          "title",
          "price",
          "duration"
